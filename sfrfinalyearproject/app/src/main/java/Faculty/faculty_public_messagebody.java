    ...
    private void fetchUserData() {
        ...
        userRepository.fetchTeacherData(username, new teacherRepository.teacherRepositoryCallback() {
            ...
            public void onFailure(Exception e) {
                ...
                Toast.makeText(faculty_public_messagebody.this, "Error fetching user data", Toast.LENGTH_SHORT).show();
            }
        });
    }
        ...
        call.enqueue(new Callback<Void>() {
            ...
            public void onResponse(Call<Void> call, Response<Void> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    Toast.makeText(faculty_public_messagebody.this, "Wishes sent successfully!", Toast.LENGTH_SHORT).show();
                    redirectToDashboard();
                } else {
                    // Show error message
                    Toast.makeText(faculty_public_messagebody.this, "Request failed: " + response.message(), Toast.LENGTH_LONG).show();
                }
            }
            ...
            public void onFailure(Call<Void> call, Throwable t) {
                ...
                // Show error message
                Toast.makeText(faculty_public_messagebody.this, "Request failed: " + t.getMessage(), Toast.LENGTH_LONG).show();
            }
        });
    }
