...
public class FavTeachercustomAdopter extends RecyclerView.Adapter<FavTeachercustomAdopter.ViewHolder> {

    private List<cuTeacher> teacherList;
    private OnTeacherClickListener clickListener;

    public FavTeachercustomAdopter(List<cuTeacher> teacherList, OnTeacherClickListener clickListener) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.favteacher, parent, false);
